...
import { AppContext } from '../context/AppContext'; // Asegúrate de ajustar la ruta según tu estructura de carpetas
  ...
  return (
    <DrawerContentScrollView {...props}>
      <View style={styles.drawerHeader}>
        <Avatar.Image
          size={100} // Puedes ajustar el tamaño según prefieras
